...
\begin{tabularx}{\textwidth}{cccc X}
      ...
      \texttt{loadi}   & $r_1$       & $i$                           & $r_2$                                                       & Copie $i + r_2$ dans $r_1$.        \\
      \texttt{loadi}   & $r_1$       & $\$l$                         & $r_2$                                                       & Copie $l_l + r_2$ dans $r_1$.      \\
      \texttt{loadi.h} & $r_1$       & $i$                           & $r_2$                                                       & Copie $i \ll 16 + r_2$ dans $r_1$. \\
      \texttt{loadi.h} & $r_1$       & $\$l$                         & $r_2$                                                       & Copie $l_h + r_2$ dans $r_1$.      \\
      \bottomrule
\end{tabularx}
